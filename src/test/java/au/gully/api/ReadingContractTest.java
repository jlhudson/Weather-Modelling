...
class ReadingContractTest {
    ...
    static Reading full() {
        ...
        return new Reading(Reading.SCHEMA, true, null, new Reading.Point(-34.93, 138.6),
                new Reading.HexagonBlock("38_-215", -34.9257, 138.5832, 17, 29.3, "station", 1.4, "Australia/Adelaide", "ADELAIDE METROPOLITAN", "SA_PW001",
                ...
                new Reading.StationBlock("023000", "ADELAIDE (WEST TERRACE / NGAYIRDAPIRA)", -34.9257, 138.5832, 29.32, 0.0, true, at, 15.0, 11.4, 3.2, 45,
                        ...
                        new Reading.WindShiftBlock(at, "sharp", "sharp", "slight", 320, 42, 82, 22.0, 11.0, -11.0, 40, "sharp change: 320° → 42° (82°), 22 → 11 km/h (-11), over 40 min"),
                        List.of(new Reading.RecentReading(at, 15.0, 45, 11.0, 42, 17.0, 0.0),
                                new Reading.RecentReading(at.minusSeconds(2400), 16.2, 40, 22.0, 320, 31.0, 0.0)),
                        new Reading.DiurnalBlock(new Reading.DiurnalDay(LocalDate.of(2026, 9, 17), 23.4, 8.1, 15.3, true),
                                new Reading.DiurnalDay(LocalDate.of(2026, 9, 18), 19.0, 9.6, 9.4, false),
                                new Reading.DiurnalPeriod(12.8, 6, 7), new Reading.DiurnalPeriod(11.9, 24, 30))),
                new Reading.NearbyBlock(1, List.of(new Reading.NearbyStation("023000", "ADELAIDE", 12.4, 29.3, 0.62), new Reading.NearbyStation("023034", "ADELAIDE AIRPORT", 18.0, 2.0, 0.38)),
                        180.0, true, -6.5, -2.0),
                fire, flood, drought,
    ...
    static Reading empty() {
        return new Reading(Reading.SCHEMA, false, "no upstream answered and the hexagon holds no reading", new Reading.Point(-34.93, 138.6),
                null, null, null, null, null, null, null, null, null, null, List.of(), null, null, null, Reading.DISCLAIMER);
    }
