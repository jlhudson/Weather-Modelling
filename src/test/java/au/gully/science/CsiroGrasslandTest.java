...
class CsiroGrasslandTest {
    ...
    void theRatingsFollowThePublishedThresholdsAfterFlooring() {
        assertThat(Bands.afdrs(11.9)).isEqualTo("No Rating");
        assertThat(Bands.afdrs(12)).isEqualTo("Moderate");
        assertThat(Bands.afdrs(23.999)).isEqualTo("Moderate");
        assertThat(Bands.afdrs(24)).isEqualTo("High");
        assertThat(Bands.afdrs(50)).isEqualTo("Extreme");
        assertThat(Bands.afdrs(100)).isEqualTo("Catastrophic");
        assertThat(Bands.afdrs(250)).isEqualTo("Catastrophic");
    }
