...
class FireDangerTest {
    ...
    void theOutlookCarriesTheDeficitForwardThroughForecastRain() {
        ...
        List<FireOutlook> dryOutlook = FireDanger.outlook(dry, 150, 550, history, null);
        List<FireOutlook> wetOutlook = FireDanger.outlook(wet, 150, 550, history, null);
    ...
    void aDryHotForecastRatesSevereOrWorse() {
        ...
        List<FireOutlook> outlook = FireDanger.outlook(
                ...
                190, 550, new java.util.ArrayList<>(java.util.Collections.nCopies(20, 0.0)), null);
    ...
    void anOutlookDayMissingAnInputCarriesNoIndexButStillCarriesTheDeficit() {
        ...
        List<FireOutlook> outlook = FireDanger.outlook(
                ...
                100, 550, new java.util.ArrayList<>(java.util.Collections.nCopies(20, 0.0)), null);
