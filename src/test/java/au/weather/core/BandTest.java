...
class BandTest {
    ...
    private static final Map<String, List<Band>> SCALES = Map.of(
            ...
            "kbdi", Kbdi.BANDS,
            "wind", WeatherBands.WIND,
            "humidity", WeatherBands.HUMIDITY,
            "temperature", WeatherBands.TEMPERATURE);
    ...
    void theCascadeIsTheIfChainItReplaced() {
        ...
        assertThat(Band.of(WeatherBands.TEMPERATURE, -3)).as("a frost is mild").isEqualTo("MILD");
        assertThat(Band.of(Kbdi.BANDS, Kbdi.FIELD_CAPACITY_MM)).isEqualTo("SEVERE");
    }

    @Test
    void theWeatherWordsChangeExactlyAtTheirBoundaries() {
        assertThat(WeatherBands.wind(19.9)).isEqualTo("LIGHT");
        assertThat(WeatherBands.wind(20)).isEqualTo("MODERATE");
        assertThat(WeatherBands.wind(39.9)).isEqualTo("MODERATE");
        assertThat(WeatherBands.wind(40)).isEqualTo("STRONG");
        assertThat(WeatherBands.wind(60)).isEqualTo("GALE");

        assertThat(WeatherBands.humidity(14.9)).isEqualTo("VERY_DRY");
        assertThat(WeatherBands.humidity(15)).isEqualTo("DRY");
        assertThat(WeatherBands.humidity(30)).isEqualTo("MODERATE");
        assertThat(WeatherBands.humidity(59.9)).isEqualTo("MODERATE");
        assertThat(WeatherBands.humidity(60)).isEqualTo("HUMID");

        assertThat(WeatherBands.temperature(19.9)).isEqualTo("MILD");
        assertThat(WeatherBands.temperature(20)).isEqualTo("WARM");
        assertThat(WeatherBands.temperature(30)).isEqualTo("HOT");
        assertThat(WeatherBands.temperature(37.9)).isEqualTo("HOT");
        assertThat(WeatherBands.temperature(38)).isEqualTo("EXTREME");
    }
