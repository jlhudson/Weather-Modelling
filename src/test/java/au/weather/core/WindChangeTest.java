...
import static au.weather.core.WindChange.WIND_CHANGE_MIN_SPEED_KMH;
import static au.weather.core.WindChange.WIND_CHANGE_TURN_DEG;
...
class WindChangeTest {
    ...
    void theFirstQualifyingHourIsTheAnswerNotTheBiggestTurn() {
        ...
        WindChange change = WindChange.find(series(dir, speed), WeatherJson.FORECAST_HOURS);
