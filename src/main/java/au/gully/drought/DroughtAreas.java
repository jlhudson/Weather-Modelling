 ...
 * property of a district, not a 32 km cell, so the plane is tiled into fixed areas of
 * {@link #RADIUS} — a hexagon and its ring, seven cells, three across, about 100 km — and one state serves
...
public class DroughtAreas {
    ...
    /**
     * The area's radius in cells: 1 is the hexagon and its ring, seven cells, three across, about 100 km.
     * 2 would be nineteen cells about 160 km across, one archive fetch for all of them, at the cost
