...
public class CsiroGrassland {
    ...
    public static Result of(Double temperatureC, Integer humidityPct, Double windKmh, Double curingPct,
        ...
        return new Result(c, round1(moisture), round2(ros / 1000.0), Math.round(intensity),
                round1(flameHeightM(c, ros)), (int) Math.floor(fbi), afdrs(fbi));
    }
    ...
    /**
     * The AFDRS rating bands, lowest first (AFDRS Technical User Guide, Table 7).
     */
    public static final java.util.List<Band> AFDRS = java.util.List.of(
