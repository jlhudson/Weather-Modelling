 ...
 * and on it a 15 km cell is 15 km from Cape York to Hobart — the cos-latitude squeeze a plain
 ...
 * in position, which matters to nobody keying a 15 km cell, and the arithmetic fits on one screen.
 */
@UtilityClass
public class Albers {
