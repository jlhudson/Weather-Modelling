 ...
 * and on it a 17 km hexagon is 17 km from Cape York to Hobart — the cos-latitude squeeze a plain
 ...
 * in position, which matters to nobody keying a 17 km hexagon, and the arithmetic fits on one screen.
 */
@UtilityClass
public class Albers {
