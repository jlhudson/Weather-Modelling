 ...
 * and on it a 32 km hexagon is 32 km from Cape York to Hobart — the cos-latitude squeeze a plain
 ...
 * in position, which matters to nobody keying a 32 km hexagon, and the arithmetic fits on one screen.
 */
@UtilityClass
public class Albers {
