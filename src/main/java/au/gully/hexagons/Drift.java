 ...
 * station's latest values against the forecast read off its series at the same moment, on the four
...
public record Drift(Instant at, String stationId, String upstream, Double temperatureC, Integer humidityPct,
    ...
    public static Optional<Drift> of(Observation o, Forecast f, ZoneId zone) {
        ...
        if (o.rainSince9amMm() != null) {
            ...
            dRain = forecastRain == null ? null : o.rainSince9amMm() - forecastRain;
        }
        ...
        return Optional.of(new Drift(o.at(), o.stationId(), f.upstream(), dT == null ? null : round1(dT), dRh,
